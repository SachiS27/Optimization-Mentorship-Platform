            ...
            {submissions[selectedWeek] ? (
              <div className="space-y-6 mb-6">
                ...
                <button
                  ...
                  className="w-full bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 text-gray-800 dark:text-gray-200 py-2 rounded-lg transition-all duration-200"
                >
                  Edit Submission
                </button>
              </div>
